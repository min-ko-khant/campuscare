    ...
    try {
      ...
      results.innerHTML = json.data
        .map((item) => {
          ...
          if (item.type === 'event') {
            link = './pages/public/event-details.html?id=' + item.id;
          }

          if (item.type === 'activity') {
            link = './pages/public/activity-details.html?id=' + item.id;
          }

          if (item.type === 'news') {
            link = './pages/public/news-details.html?id=' + item.id;
          }

          if (item.type === 'announcement') {
            link = './pages/public/announcement-details.html?id=' + item.id;
          }

          if (item.type === 'emergency') {
            link = './pages/public/emergency-details.html?id=' + item.id;
          }
